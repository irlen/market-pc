...
const indusCityTechnology = (state={modules:[],cityTechnologyInfo:{},cityTechnologyDetail:{}},action)=>{
  switch(action.type){
   case 'INIT_MODULES_FOR_CITYTECHNOLOGY':
     let new2State = _.cloneDeep(state)
     new2State.modules = action.value
     return Object.assign({},new2State)
   case 'SET_POSITION_FOR_CITYTECHNOLOGY':
  ...
  case 'SET_CITYTECHNOLOGY_INFO':
    let new4State = _.cloneDeep(state)
    new4State.cityTechnologyInfo = _.cloneDeep(action.value)
    return Object.assign({},new4State)
  case 'SET_CITYTECHNOLOGY_DETAIL':
    let new5State = _.cloneDeep(state)
    new5State.cityTechnologyDetail = _.cloneDeep(action.value)
...
export default indusCityTechnology
