...
export const routerConfig = [
  {
    ...
    key:"/app/change",
    children:[
      {path:"/app/change/changerequest",key:"changerequest",name:"变更请求",icon: <span style={{verticalAlign:"middle",marginRight:"10px"}}><GiCardExchange /></span>},
  ...
  },
  {
    ...
    key:"/app/look",
    children:[
      {path:"/app/look/lookset",key:"lookset",name:"ACL及策略",icon: <span style={{verticalAlign:"middle",marginRight:"10px"}}><FaRegListAlt /></span>},
    ]
  },
  {
    path:"/app/set",
    ...
    key:"/app/set",
    children:[
      {path:"/app/set/setmonitor",key:"setmonitor",name:"监控设备",icon: <span style={{verticalAlign:"middle",marginRight:"10px"}}><FaServer /></span>},
